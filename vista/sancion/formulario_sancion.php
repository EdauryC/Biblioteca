...
$registros=$carrera->selectAll("sancion",$con);
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
		<title>Formulario Reporte de Sanciones</title>
	 ...
	 if(isset($_SESSION["autenticado"])){
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark bg-company-red  px-4">
            ...
            <img src="../images/Libro.png" class="" width="30" height="30" alt="">
		      ...
		      <a class="navbar-brand mx-auto" href="../../vista/sancion/listar_sancion.php">Formulario de Reporte de Sanciones</a>
	      	<a class="nav-item nav-link text-white "href="../../vista/sancion/listar_sancion.php">Ir a la lista</a>
     	</nav>
  	...
  	<div class="container">
			<div class="table-responsive">
	      	...
	      	<div class="table-title">
			      <div class="row">
			       	<div class="col">
			      		<h2>Formulario para Reportes de <b>Sanciones</b></h2>
			      	</div>
		       </div>
         </div>
	        ...
	        <table class="mx-auto ">
	      	  	...
	      	  	<?php
			        	...
			        	while (($fila=$registros->fetch_assoc())>0) 
		        		{
		        			...
		        			echo "</tr>";
									$suma= $fila['id_sancion'].','.$fila['usuario_id_usuario'].','.$fila['fecha_inicio'].','.$fila['fecha_fin'].','.$fila['status'].'|';
		         			$compiladosancion = $compiladosancion.$suma;	
		        		}
		        	?>
	        	</table>
						<form method="POST" action="imprimirPDF.php">
		         			<input type='hidden' id='compiladosancion' name='compiladosancion' value='<?php echo $compiladosancion?>'>
