...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Realizar nueva Sancion</title>
...
<body onload="document.getElementById('usuario_id_usuario').focus();" class="table">
	...
	<form method="POST" name="form_car" id="form_car">
		...
		<a class="navbar-brand" href="#">
         <img src="../images/Libro.png" class="" width="30" height="30" alt="">
			...
			<a class="navbar-brand mx-auto" href="../../vista/sancion/Ingresar_sancion.php">Area de Registro</a>
			     ...
			     <table class="table container mx-auto">
					      <tr class="row justify-content-center d-none">
						      	...
						      	<tr class="row justify-content-center">
						      		 ...
						      		 <td class="col-auto border-0"><input type="date" id="fecha_inicio" name="fecha_inicio" size="20" maxlength="50" placeholder="Ingrese su apellido" onblur="soloMayusculas('fecha_inicio')"></td>
						      	</tr>
						      	<tr class="row justify-content-center">
						      		 <td class="col-auto border-0">Fecha de Finalizacion</td>
						      		 <td class="col-auto border-0"><input type="date" id="fecha_fin" name="fecha_fin" size="20" maxlength="10" placeholder="Ingrese su usuario" onblur="soloMayusculas('fecha_fin')"></td>
						      	</tr>
						      	<tr class="row justify-content-center">
						      		 <td class="col-auto border-0">ID Usuario Amonestado</td>
						      		 <td class="col-auto border-0"><input type="text" id="usuario_id_usuario" name="usuario_id_usuario" size="20" maxlength="30" placeholder="Ingrese ID usuario" onblur="soloMayusculas('usuario_id_usuario')"></td>
						      	</tr>
		               	<tr class="border-0">
