...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Area de Busqueda de libros</title>
...
<body onload="document.getElementById('id_libro').focus();">
           ...
           <img src="../images/Libro.png" class="" width="30" height="30" alt="">
					...
					<a class="navbar-brand mx-auto" href="../../vista/libro/buscar_libro.php">Busqueda de libros</a>
					<a class="nav-item nav-link text-white"href="../../vista/libro/listar_libro.php">Volver a la lista</a>
				</nav>
		...
		<div class="container">
			 <div class="table-responsive">
		       ...
		       <div class="table-title">
			         <div class="row">
			          	<div class="col">
			          		<h2>Realizar busqueda de <b>libros</b></h2>
			        	</div>
		         </div>
          </div>
	           ...
	           <table class="table">
			           <tr>
		           		<td class="border-0" align="center"><input type="text" id="id_libro" name="id_libro" size="20" maxlength="30" placeholder="Ingrese el ID del libro" onblur="soloMayusculas('id_libro')"></td>
		           	</tr>
		           		<td class="border-0" colspan="2" align="center">
		           			<input type="button" name="btnEnviar" id="btnEnviar" value="Consultar" class="btn btn-primary" onclick="return validaCarrera('incluir')">
		           		</td>
		           	</tr>
	          	</table>
		 ...
		 <div class="container">
			  <div class="table-responsive">
		        ...
		        <div class="table-title">
			          <div class="row">
			           	<div class="col">
	                  	<h3>Resultado de <b>Busqueda</b></h3>
			          	</div>
		          </div>
           </div>
            ...
            <tr>
              <td align="center" class="cabecera_columna">Cota del libro</td>
            	...
            	<td align="center" class="cabecera_columna">Ver mas</td>
            </tr>
	...
	<div class="container">
			  <div class="table-responsive">
		        ...
		        <div class="table-title">
			          <div class="row">
			           	<div class="col">
	                  	<h4>Informacion del Libro <b>Seleccionado</b></h4>
			          	</div>
		          </div>
           </div>    
					       <table class="table">
                      ...
                      <tr>
	                      <td align="center" class="cabecera_columna">Cota del Libro</td>
												<td align="center" class="cabecera_columna">Codigo del Libro</td>
												<td align="center" class="cabecera_columna">Nombre</td>
	                       <td align="center" class="cabecera_columna">Descripcion</td>
	                      <td class="cabecera_columna">Categoria</td>
	                      <td align="center" class="cabecera_columna">Numero de ejemplares</td>
	                      <td align="center" class="cabecera_columna">Status</td>
                      	<td align="center" class="cabecera_columna">Confirmar</td>
                      </tr>
      ...
      $con2 = $consulta->conexion(); 
      $registros=$consulta->selectAll("usuario",$con2);
      ?>	
          
					 <table class="table">
			           <tr>
		           		<td class="border-0" align="center"><input type="text" id="n_cedula" name="n_cedula" size="20" maxlength="30" placeholder="Ingrese la cedula del usuario" onblur="soloMayusculas('n_cedula')"></td>
		           	</tr>
		           		<td class="border-0" colspan="2" align="center">
		           			<input type="button" name="btnEnviar" id="btnEnviar" value="Consultar" class="btn btn-primary" onclick="return validaCarrera('incluir')">
		           		</td>
