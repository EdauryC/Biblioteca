  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	        ...
	        <nav class="navbar navbar-expand-lg navbar-dark bg-company-red px-4">
             <a class="navbar-brand" href="#">
                <img src="../images/Libro.png" class="" width="30" height="30" alt="">
		         ...
		         <a class="navbar-brand mx-auto" href="../../vista/empleado/formulario_empleado.php">Formulario de empleados</a>
	...
	<div class="container">
		            	...
		            	<?php
		             	$compiladoempleado ='';
		         	   	while (($fila=$registros->fetch_assoc())>0) 
		         		  {
		         			...
		         			echo "</tr>";
		         			$suma= $fila['id_empleado'].','.$fila['nombres'].','.$fila['apellidos'].','.$fila['n_cedula'].','.$fila['tipo_empleado_id_tipo_empleado'].'|';
		         			$compiladoempleado = $compiladoempleado.$suma;	
		         	  	}
		         		  ?>
		           </table>
		         		<form method="POST" action="imprimirPDF.php">
		         			<input type='hidden' id='compiladoempleado' name='compiladoempleado' value='<?php echo $compiladoempleado?>'>
	     	...
	     	<br>
		        ...
		        <script src="../empleado/js/libreria_ing.js"></script> 	</body>
      <?php
   }
 else
{
