	...
	<body>
		...
		?>
				<nav class="navbar navbar-expand-lg  navbar-dark bg-company-red  px-4">
					...
					<a class="navbar-brand mx-auto" href="../../vista/prestamo/listar_prestamo.php">Lista de Prestamos</a>
					...
					<div class="dropdown d-inline-block">
						...
						<div class="dropdown-menu w-100" arialabelledby="dropdownMenuButton">
							<div class="dropdown-content">
								...
								<a href="../../vista/prestamo/devolver.php">Devolver Prestamo</a>
							</div>
						</div>
				</nav>
						...
						<div class="table-wrapper">
							...
							<table class="table table-responsive mx-auto">
								...
								while (($fila = $registros->fetch_assoc()) > 0) {
									...
									echo "<td align='center'><input type=image src='../images/borrar.png' onclick='eliminaCarrera(this," . $fila['id_prestamo'] . ")'></td>";
									echo "</tr>";
								}
								?>
							</table>
