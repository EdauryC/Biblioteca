	 ...
	 if(isset($_SESSION["autenticado"])){
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark bg-company-red px-4">
            ...
            <img src="../images/Libro.png" class="" width="30" height="30" alt="">
		      ...
		      <a class="navbar-brand mx-auto" href="../../vista/sancion/listar_sancion.php">Reportes de Usuarios</a>
	      	<a class="nav-item nav-link text-white "href="../../vista/usuarios/listar_usuarios.php">Lista de Usuarios</a>
	        ...
	        <table class="mx-auto ">
	      	  	...
	      	  	<?php
			        	...
			        	while (($fila=$registros->fetch_assoc())>0) 
		        		{
		        			...
		        			echo "</tr>";
									$suma= $fila['id_usuario'].','.$fila['n_cedula'].','.$fila['nombres'].','.$fila['apellidos'].','.$fila['usuario'].','.$fila['status'].'|';
		         			$compiladousuario = $compiladousuario.$suma;
		        		}
		        	?>
	        	</table>
						<form method="POST" action="imprimirPDF.php">
		         			<input type='hidden' id='compiladousuario' name='compiladousuario' value='<?php echo $compiladousuario?>'>
