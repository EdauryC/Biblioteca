...
require("../../modelo/usuarios.php");  //A base de datos
...
function Header()
{
    ...
    $this->Cell(56, 10, 'Nombre', 0, 0, 'C', 1);
    $this->Cell(56, 10, 'Apellido', 0, 0, 'C', 1);
    $this->Cell(19, 10, 'Status', 0, 0, 'C', 1);
...
while($row = $registros->fetch_assoc()){
    $pdf->Cell(7, 10, $row['id_usuario'], 1, 0, 'C', 1);
    $pdf->Cell(25, 10, $row['n_cedula'], 1, 0, 'C', 1);
    $pdf->Cell(56, 10, $row['nombres'], 1, 0, 'L', 1);
    $pdf->Cell(56, 10, $row['apellidos'], 1, 0, 'L', 1);
    $pdf->Cell(19, 10, $row['status'], 1, 0, 'C', 1);
