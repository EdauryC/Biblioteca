  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-company-red px-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
      <div class="navbar-nav">
         <a class="nav-item nav-link text-white" href="../../vista/libro/listar_libro.php"> Buscar libros</a>
  ...
  <div class="modal-dialog principalModal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="../../vista/libro/listar_libro.php" class="btn btn-primary btn-block my-auto w-50 bg-info text-white" >Ir a Libros</a>
