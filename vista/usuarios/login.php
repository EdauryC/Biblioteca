...
<body>
  ...
  ?>
    <style>
      ...
      .bg-success {
       background-color: #75CEE6 !important;
      }
    </style>
          ...
          <div class="modal-dialog modal-login">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <a href="registrar_usuarios.php" class="btn btn-link mt-3 mb-0">Registrarse</a>
                 <a href="../empleado/login.php" class="btn btn-link mt-3 mb-0">¿Eres Empleado? Entra aqui</a>
